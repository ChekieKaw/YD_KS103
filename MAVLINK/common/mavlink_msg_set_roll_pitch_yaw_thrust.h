						       ...
						       uint8_t target_system, uint8_t target_component, float roll, float pitch, float yaw, float thrust)
{
	...
	_mav_put_float(buf, 0, roll);//*(float *)&buf[wire_offset] = b
	...
	packet.target_component = target_component;
        ...
        memcpy(_MAV_PAYLOAD_NON_CONST(msg), &packet, MAVLINK_MSG_ID_SET_ROLL_PITCH_YAW_THRUST_LEN);//((char *)(&((msg)->payload64[0])))<-package
#endif
